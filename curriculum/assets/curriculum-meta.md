...
```json
{
  ...
  "module": "03-classification-fundamentals",
  "question_id": "q2",
  "question": "Why does logistic regression output a probability instead of a class?",
  "response": "learner's raw answer, verbatim",
  "assessment": {
    ...
    "strengths": ["identified the sigmoid squashing intuition"],
    "gaps": ["did not connect probability output to threshold choice"],
    "misconceptions": ["conflated logistic regression with linear regression's continuous output"],
    "notes": "free-form observations"
  },
  "adaptation": {
    "revisit_before_next_module": ["threshold choice and its relation to decision rules"],
    "accelerate": [],
    "emphasize_in_next_module": [],
    "followup_question": "If the output is already a probability, what does the threshold actually change?"
  }
}
```
